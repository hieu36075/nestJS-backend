import { Controller, UseInterceptors, Get, UseGuards, Post, Body, Patch, Param, Delete, HttpCode, HttpStatus, Query } from "@nestjs/common";
...
export class CategoriesController{
    ...
    @Post()
    createCategories(@Body() createCategoryDTO :CreateCategoryDTO ):Promise<Category>{
        return this.categoriesService.createCategory(createCategoryDTO);
    }

    @Patch()
    updateCategories(@Param(':id') categoryId: string, @Body() updateCategoryDTO : UpdateCategoryDTO): Promise<Category | null>{
